    ...
    <footer className="bg-[#f8f8f8] text-[#222] py-10 px-4">
      ...
      <div className="hidden md:block">
        ...
        <div className="max-w-7xl mx-auto flex justify-center gap-5 text-lg mt-10">
          ...
          <a href="https://wa.me/96171504584"><FaWhatsapp className="text-[#333] cursor-pointer" /></a>
          <a href="https://www.instagram.com/cozy_byhoda/p/DD2lQPIiQdF/"><FaInstagram className="text-[#333] cursor-pointer" /></a>
          <a href="https://www.facebook.com/profile.php?id=100095316781172"><FaFacebook className="text-[#333] cursor-pointer" /></a>
        </div>

        {/* Bottom */}
        <div className="text-center mt-10 mb-20">
          <p className="text-sm uppercase">Cozy by Hoda 2025 ALL RIGHTS RESERVED</p>
        </div>
      </div>
